    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodicity', models.CharField(choices=[('раз в день', 'день'), ('раз в неделю', 'неделя'), ('раз в месяц', 'месяц')], verbose_name='периодичность')),
                ('status', models.CharField(blank=True, choices=[('завершена', 'завершена'), ('создана', 'создана'), ('запущена', 'запущена')], null=True, verbose_name='статус')),
                ('message', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mailings.mailingmessage', verbose_name='сообщение')),
                ('clients', models.ManyToManyField(to='mailings.recipientclient', verbose_name='клиенты')),
            ],
            options={
